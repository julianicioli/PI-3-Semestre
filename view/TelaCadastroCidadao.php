...
<body>
    ...
    <div>
         <form class="formfuncionario"  action="model/cadastroCidadao.php" method="post">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Consulta de endereço via CEP (mesmo script anterior)
    cepInput.addEventListener('blur', function () {
        ...
        fetch(`https://viacep.com.br/ws/${cep}/json/`)
            .then(response => {
                if (!response.ok) throw new Error('Falha na conexão com o serviço de CEP');
            ...
            <input type="password" name="senha" id="senha" placeholder="Letras (A,a) - Números (1,5,9) - Símbolos (@#$)">
    ...
    <div vw class="enabled">
        ...
        #readAllButton {
            ...
            <button id="voiceReaderToggle" aria-pressed="false" title="Ativar leitor falado">🗣️ Leitor</button>
            <button id="readAllButton" title="Ler toda a página">📖 Ler Tudo</button>
            ...
            btn.addEventListener('click', () => {
                ...
                btn.textContent = active ? '🟢 Leitor Ativo' : '🗣️ Leitor';
